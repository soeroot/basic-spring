...
import soerjadi.learning.spring.core.service.AuthService;
...
public class AwareTest {
  ...
  void testAware(){
    ...
    Assertions.assertEquals("soerjadi.learning.spring.core.service.AuthService", authService.getBeanName());
